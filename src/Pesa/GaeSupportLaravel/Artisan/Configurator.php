...
use Dotenv\Dotenv;
use Pesa\GaeSupportLaravel\Storage\Optimizer;
...
class Configurator
{
    ...
    protected function replaceAppClass($contents)
    {
        $modified = str_replace(
            ...
            'Pesa\GaeSupportLaravel\Foundation\Application',
            $contents);

        $modified = str_replace(
            'Laravel\Lumen\Application',
            'Pesa\GaeSupportLaravel\Foundation\LumenApplication',
            $contents);
    ...
    protected function replaceLaravelServiceProviders($contents)
    {
        ...
        $replacements = [
            'Pesa\GaeSupportLaravel\View\ViewServiceProvider',
        ];
